...
ToolBase.prototype.init = function(){}
ToolBase.prototype.kill = function(){}
...
PenTool.prototype.isUpMove = false;
PenTool.prototype.getColor = function(jspainter)
{
	return jspainter.foregroundColor;
}

PenTool.prototype.downHandler = function(jspainter)
{
...
PenTool.prototype.upHandler = function(jspainter)
{
	if(isUpMove==true){
	}else{
		//Register undo first;
...
PenTool.prototype.moveHandler = function(jspainter)
{	
	var ctx = jspainter.tempCanvasCtx;
...
PenTool.prototype.drawCursor = function(jspainter)
{
...
PenTool.prototype.upMoveHandler = function(jspainter)
{
	isUpMove = true;
	jspainter.updateDestCanvas(0,0,jspainter.canvasWidth, jspainter.canvasHeight, true);
	this.drawCursor(jspainter);
}
PenTool.prototype.rollOverHandler= function(jspainter)
{
	
}
PenTool.prototype.rollOutHandler= function(jspainter)
{
...
EraserTool.prototype = new PenTool();
...
ColorPickerTool.prototype.drawCursor = function(jspainter)
{
	var x = jspainter.mouseX;
	var y = jspainter.mouseY;
